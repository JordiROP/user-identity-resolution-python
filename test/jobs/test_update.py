...
def test_update_add_existing_users():
    ...
    u32.intr_grp.update({u62})
    u33.intr_grp.update({u62})
    u62.intr_grp.update({u32, u33})
    ...
    expected_recompute = {"u2","u22","u31","u32","u33","u62","u6","u61","u62"}
    ...
    assert db.interactions == expected_interactions
    assert db.users == expected_users
    assert db.recompute == expected_recompute
...
def test_update_remove_users():
    ...
    u2.intr_grp.remove(u32)
    u22.intr_grp.remove(u32)
    u31.intr_grp.remove(u32)
    u32.intr_grp.remove(u2)
    u32.intr_grp.remove(u22)
    u32.intr_grp.remove(u31)
    ...
    expected_recompute = {"u2","u22","u31","u32","u33"}
